        ...
        <div className='p-3 max-w-lg mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                ...
                <button className='bg-slate-700 text-white p-3
                   rounded-lg uppercase hover:opacity-95 uppercase hover:opacity-95disabled:opacity-80   '>{loading ? 'Loading.. ' : 'Update'}</button>
            </form>
            ...
            <p className='text-green-700 mt-5 '>{updateSuccess && 'User is updated Succesfuly'}</p>
